# -*- coding: utf-8 -*-
"""MKD Clean for DCAF201

This is the file that transforms Daria output to the safer 
(and more useful!) csv used for regular vol activities.
...
file1 = drive.CreateFile({'id': 'XXX  REDACTED  XXX'}) #see MKD for info on this
...
df['Fulfilled Amount - Matcher'] = df['amount']
...
df2=df[['Has Alt Contact?', 'Voicemail Preference', #whitelist currently desired fields
                ...
                'Call count', 'Reached Patient call count', 'Fulfilled', 'Fulfilled Amount - Matcher', 'Gestation at procedure in weeks',
...
df2.to_csv('dcaf_vol.csv')

file_metadata = {
  'name': 'DCAF csv 4 - 14 - 2019',
  'mimeType': 'text/csv'
}
media = MediaFileUpload('dcaf_vol.csv', 
                        mimetype='text/csv',
                        resumable=True)
